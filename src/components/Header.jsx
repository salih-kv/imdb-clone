...
const Header = () => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-p-dark items-center py-6 mb-8 px-4">
      <div className="flex justify-between gap-12 max-w-screen-2xl mx-auto">
        <div className="flex items-center space-x-5">
          <Link href="/">
            <h2 className="text-2xl overflow-hidden py-1">
